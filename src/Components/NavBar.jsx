...
const NavBar = ({searchBar, backgroundColor, borderBottom, textColor}) => {
  return (
    <nav className={`w-full px-[2rem] md:px-[5rem] py-[2rem] bg-${backgroundColor} flex justify-between items-center ${borderBottom && 'border-b-[1.5px]'} ${textColor}`}>
      <NavLink
        to={"/"}
      ...
      >
        <svg
          ...
          className="w-[4.5rem] rounded-xl bg-white"
        >
      ...
      <div className="capitalize text-[2.3rem] gap-7 flex font-[500] items-center">
        ...
        <NavLink
          className={`bg-black rounded-xl text-white px-[1.7rem] py-[0.9rem] text-[1.6rem] hover:opacity-[0.7] hidden md:block`}
        >
          join
        </NavLink>
